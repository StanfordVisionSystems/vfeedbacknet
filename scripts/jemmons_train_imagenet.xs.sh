...
IMAGENET_ROOT=$WORK/datasets/imagenet2012.xs
...
python3 -u -B $DIR/vfeedbacknet_train $IMAGENET_ROOT/imagenet2012_labels.txt \
        ...
        $2 \
        $3 \
        $3/training_log.csv --imagenet --video_length=1 --video_downsample_ratio=1 --pretrain_root_prefix=$WORK/pretrained-models  $EXTRA_ARGS 2>&1 | tee -a $3/training_log.log 
