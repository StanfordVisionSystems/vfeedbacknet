...
class VFeedbackNetModel5:
    ...
    def _declare_variables(self):
        ...
        with tf.variable_scope('vfeedbacknet_model5'):
...
if __name__ == '__main__':
    ...
    #vfeedbacknet_model5 = VFeedbackNetModel5(sess, 27))
    vfeedbacknet_model5 = VFeedbackNetModel5(sess, 27, train_featurizer='NO', weights_filename='/home/jemmons/vfeedbacknet_base_weights.npz')

    logits = vfeedbacknet_model5(x, x_len)
    ModelLogger.log('logits', logits)

    vfeedbacknet_model5.initialize_variables()
    vfeedbacknet_model5.export_variables('/tmp/weights.npz')
    vfeedbacknet_model5.print_variables()
