...
class Model:
    ...
    def _declare_variables(self):
        ...
        with tf.variable_scope('vfeedbacknet_{}'.format(Model.model_name)):
            ...
            with tf.variable_scope('feedbackcell1'):
                self.feedbackLSTMCell1 = FeedbackLSTMCell_stack1([14, 14, 128], Model.NFEEDBACK)
    ...
    def __call__(self, inputs, inputs_sequence_length):
        ...
        inputs = [ self.feedbackLSTMCell1.apply_layer([inp for _ in range(Model.NFEEDBACK) ], var_list=self.main_model_variables) for inp in inputs]
