...
class Model:
    ...
    def _declare_variables(self):
        ...
        with tf.variable_scope('vfeedbacknet_model1'):
            ...
            with tf.variable_scope('feedbackcell1'):
                self.feedbackLSTMCell1 = FeedbackLSTMCell_stack1([4, 4, 512], Model.NFEEDBACK)  
    ...
    def __call__(self, inputs, inputs_sequence_length):
        ...
        for fbi in range(Model.NFEEDBACK):
            ...
            inputs = self.convLSTM_layer1(fb_sequence[fbi], inputs_sequence_length, var_list=self.main_model_variables)
