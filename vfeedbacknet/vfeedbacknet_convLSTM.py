...
class ConvLSTMCell(tf.nn.rnn_cell.RNNCell):
  ...
  def __init__(self, shape, filters, kernel, forget_bias=1.0, activation=tf.tanh, normalize=True, peephole=True, data_format='channels_last', reuse=None, is_training=True):
