...
def vfeedbacknet_vgg(video_length, video_width, video_height, num_labels, input_placeholder, input_length, output_placeholder, zeros):
    '''
    A feedback model with vgg featurizer
    '''
    
    conv_b = new_bais()
    conv_w = new_conv2dweight(10, 10, 3, 96)
    ...
    # predictions = tf.stack(fc_outputs, name='predictions')
