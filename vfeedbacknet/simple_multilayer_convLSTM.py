...
def simple_multilayer_convLSTM(video_length, video_width, video_height, num_labels, input_placeholder, input_length, output_placeholder, zeros):
    '''
    ...
    # convLSTM 2 (parts need to run on CPU) ####################################
    ...
    # convLSTM 3 (parts need to run on CPU) ####################################
    ...
    # convLSTM 4 (parts need to run on CPU) ####################################
    ...
    with tf.device("/device:CPU:0"):
        ...
        #cross_entropies_truncated = [ tf.where(i < input_length, zeros, cross_entropies_truncated[i]) for i in range(video_length) ]
