    ...
    def _declare_variables(self):
        ...
        with tf.variable_scope('vfeedbacknet_{}'.format(Model.model_name)):
            ...
            with tf.variable_scope('feedbackcell1'):
                self.feedbackLSTMCell1 = FeedbackLSTMCell_stack1([14, 14, 64], Model.NFEEDBACK_ITERATIONS)
            ...
            with tf.variable_scope('reshape_convs'):
                with tf.variable_scope('conv1'):
                    ...
                    kernel = tf.get_variable('kernel', shape=[3, 3, 128, 64], dtype=tf.float32, regularizer=regularizer, initializer=initializer)
            ...
            with tf.variable_scope('fc1'):
                ...
                weight = tf.get_variable('weights', shape=[128, 256], dtype=tf.float32, initializer=initializer, regularizer=regularizer, trainable=trainable)
